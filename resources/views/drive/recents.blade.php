...
<div class="drive-view">
    <div class="drive-header d-flex jc-between ai-center mg-b-20">
        <div>
            <h1 class="fs-24 fw-700">Recents</h1>
            <div class="fs-12 clr-grey1">Recently accessed or modified files will appear here</div>
        </div>

        <div class="drive-actions d-flex ai-center gap-10">
            <form method="GET" action="{{ route('drive.search') }}" class="drive-search">
                <input type="search" name="q" placeholder="Search recent files" class="drive-search-input">
            </form>
    ...
    <div class="drive-toolbar d-flex jc-between ai-center mg-b-15">
        <div class="drive-toolbar-left d-flex ai-center gap-8">
            <span class="fs-13 clr-grey2">Showing your recent activity</span>
        </div>
    ...
    <div class="drive-grid" id="drive-grid">
        ...
        @php
            $examples = [
                ['title' => 'Meeting Notes.docx', 'icon' => 'ri-file-word-line'],
                ['title' => 'Design Mockup.png', 'icon' => 'ri-image-2-line'],
                ['title' => 'Sales Q1.xlsx', 'icon' => 'ri-file-excel-line'],
                ['title' => 'Project Slides.pptx', 'icon' => 'ri-slideshow-line'],
            ];
        @endphp
        ...
        <div class="drive-empty-card">
            <div class="fs-18 fw-600">No recent activity</div>
            <div class="fs-13 clr-grey2 mg-t-8">Open or edit files and they will appear here.</div>
        </div>
    </div>
</div>
@endsection
