...
<div class="drive-view">
    <div class="drive-header d-flex jc-between ai-center mg-b-20">
        <div>
            <h1 class="fs-24 fw-700">Trash</h1>
            <div class="fs-12 clr-grey1">Deleted files are kept here for 30 days before permanent deletion</div>
        </div>

        <div class="drive-actions d-flex ai-center gap-10">
            <form method="GET" action="{{ route('drive.search') }}" class="drive-search">
                <input type="search" name="q" placeholder="Search trash" class="drive-search-input">
            </form>
    ...
    <div class="drive-toolbar d-flex jc-between ai-center mg-b-15">
        <div class="drive-toolbar-left d-flex ai-center gap-8">
            <span class="fs-13 clr-grey2">Items in trash</span>
        </div>

        <div class="drive-toolbar-right fs-12 clr-grey2">
            <span>Emptying schedule: Automatic after 30 days</span>
        </div>
    </div>
    ...
    <div class="drive-grid" id="drive-grid">
        ...
        @php
            $examples = [
                ['title' => 'Old Draft.docx', 'icon' => 'ri-file-word-line'],
                ['title' => 'Unused Image.png', 'icon' => 'ri-image-2-line'],
            ];
        @endphp
        ...
        <div class="drive-empty-card">
            <div class="fs-18 fw-600">Trash is empty</div>
            <div class="fs-13 clr-grey2 mg-t-8">Deleted files will appear here for 30 days.</div>
        </div>
    </div>
</div>
@endsection
