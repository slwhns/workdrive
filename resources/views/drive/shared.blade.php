...
<div class="drive-view">
    <div class="drive-header d-flex jc-between ai-center mg-b-20">
        <div>
            <h1 class="fs-24 fw-700">Shared with me</h1>
            <div class="fs-12 clr-grey1">Files other people have shared with you</div>
        </div>

        <div class="drive-actions d-flex ai-center gap-10">
            <form method="GET" action="{{ route('drive.search') }}" class="drive-search">
                <input type="search" name="q" placeholder="Search shared files" class="drive-search-input">
            </form>
    ...
    <div class="drive-toolbar d-flex jc-between ai-center mg-b-15">
        <div class="drive-toolbar-left d-flex ai-center gap-8">
            <span class="fs-13 clr-grey2">Showing items shared with you</span>
        </div>
    ...
    <div class="drive-grid" id="drive-grid">
        ...
        @php
            $examples = [
                ['title' => 'Project Plan.docx', 'icon' => 'ri-file-word-line'],
                ['title' => 'Budget.xlsx', 'icon' => 'ri-file-excel-line'],
                ['title' => 'Team Photos', 'icon' => 'ri-folder-3-line'],
            ];
        @endphp
        ...
        <div class="drive-empty-card">
            <div class="fs-18 fw-600">No shared files</div>
            <div class="fs-13 clr-grey2 mg-t-8">When someone shares files with you, they'll appear here.</div>
        </div>
    </div>
</div>
@endsection
